...
impl Pawn {
    ...
    pub fn pawn_moves(
        ...
        latest_move: (Option<PieceType>, i8),
    ) -> Vec<Vec<i8>> {
        ...
        match latest_move.0 {
            Some(PieceType::Pawn) => {
                let from_y: i8 = latest_move.1 / 1000 % 10;
                let from_x: i8 = latest_move.1 / 100 % 10;
                let to_y: i8 = latest_move.1 / 10 % 10;
                let to_x: i8 = latest_move.1 % 10;
